  ...
  <div class="flex min-h-[calc(100vh-4rem)] items-center justify-center py-12">
    <div class="w-full max-w-md">
      ...
      <div class="mb-8 text-center">
        ...
        <p class="mt-1 text-sm text-slate-500">Sign in to continue to TaskFlow</p>
      </div>
      ...
      <p class="mt-6 text-center text-sm text-slate-500">
        ...
        <NuxtLink to="/register" class="font-semibold text-indigo-600 hover:text-indigo-700 transition-colors">
          Create one
        </NuxtLink>
      </p>
    </div>
...
import { CheckSquare, Mail, Lock, Eye, EyeOff, AlertCircle, Loader2, ArrowRight } from 'lucide-vue-next'
