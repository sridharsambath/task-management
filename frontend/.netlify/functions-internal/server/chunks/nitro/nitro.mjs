...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "f89f87eb-935d-4cfb-9129-bb6bc62e742d",
...
const _lazy_AMOWI_ = () => import('../routes/api/ai-suggest.post.mjs');
const _lazy_5XMhlh = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/ai-suggest', handler: _lazy_AMOWI_, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_5XMhlh, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_5XMhlh, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch as $, deleteCookie as A, createHooks as B, defu as C, executeAsync as D, parseQuery as E, withTrailingSlash as F, withoutTrailingSlash as G, handler as H, getResponseStatus as a, defineRenderHandler as b, createError$1 as c, defineEventHandler as d, getQuery as e, getRouteRules as f, getResponseStatusText as g, joinURL as h, useNitroApp as i, joinRelativeURL as j, encodePath as k, decodePath as l, hasProtocol as m, isScriptProtocol as n, getContext as o, parseURL as p, klona as q, readBody as r, sanitizeStatusCode as s, getRequestHeader as t, useRuntimeConfig as u, destr as v, withQuery as w, isEqual as x, setCookie as y, getCookie as z };
